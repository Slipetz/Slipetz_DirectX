...
CPlyFile5nt_DX11::CPlyFile5nt_DX11() 
{
...
//static 
unsigned int CPlyFile5nt_DX11::statNextID = 1;

CPlyFile5nt_DX11::~CPlyFile5nt_DX11()
{
}

CPlyFile5nt_DX11::CPlyFile5nt_DX11( const CPlyFile5nt_DX11 &rhs )	// Copy constructor
{
...
CPlyFile5nt_DX11& CPlyFile5nt_DX11::operator=( const CPlyFile5nt_DX11 &rhs )
{
...
unsigned int CPlyFile5nt_DX11::GetID( void ) 
{
	return this->m_ID;
}

bool CPlyFile5nt_DX11::ReadPLYFileHeader(std::wstring fileName, std::wstring &error)
{
		error = L"OK";
...
bool CPlyFile5nt_DX11::OpenPLYFile(std::wstring fileName, std::wstring &error)
{
	error = L"OK";
...
//                                                                                       |__/ 
void CPlyFile5nt_DX11::normalizeTheModelBaby(void)
{
...
//                                                                                       |__/|___|              |___|    |___|            
void CPlyFile5nt_DX11::normalizeTheModelBaby_Rock_n_Roll(void)
{
...
//
void CPlyFile5nt_DX11::GenTextureCoordsSpherical( enumTEXCOORDBIAS uBias, enumTEXCOORDBIAS vBias, bool basedOnNormals, float scale, bool fast )
{
...
//                                                                                       |__/                                                         |___|              |___|    |___|            
void CPlyFile5nt_DX11::normalizeTheModelBabyDirectXVersion_Rock_n_Roll(void)
{
	//// Go through all the faces, calculate the normal and 
	////	save (overwrite) the normals at that faces vertices.
	//// DIRECTX Version
...
PLYVERTEX CPlyFile5nt_DX11::getVertex_at(std::vector<PLYVERTEX>::size_type index)
{
	PLYVERTEX x = this->m_verticies.at( index );
	return x;
}

PLYELEMENT CPlyFile5nt_DX11::getElement_at(std::vector<PLYELEMENT>::size_type index)
{
...
void CPlyFile5nt_DX11::m_setIndexBasedOnPropertyName(int curIndex, std::wstring propName)
{
...
bool CPlyFile5nt_DX11::m_placeItemInAppropriateVertexLocation( std::wstring tempString, int propertyIndex, PLYVERTEX &tempVertex )
{
...
int CPlyFile5nt_DX11::GetNumberOfVerticies(void)
{
	//int x = static_cast<int>( this->m_verticies.size() );
	return this->m_numberOfVertices;
}

int CPlyFile5nt_DX11::GetNumberOfElements(void)
{
	//int x = static_cast<int>( this->m_elements.size() );
	return this->m_numberOfElements;
}

float CPlyFile5nt_DX11::getMaxX(void)
{
	return this->m_maxX;
}

float CPlyFile5nt_DX11::getMinX(void)
{
	return this->m_minX;
}

float CPlyFile5nt_DX11::getDeltaX(void)
{
	return this->m_deltaX;
}

float CPlyFile5nt_DX11::getMaxY(void)
{
	return this->m_maxY;
}

float CPlyFile5nt_DX11::getMinY(void)
{
	return this->m_minY;
}

float CPlyFile5nt_DX11::getDeltaY(void)
{
	return this->m_deltaY;
}

float CPlyFile5nt_DX11::getMaxZ(void)
{
	return this->m_maxZ;
}

float CPlyFile5nt_DX11::getMinZ(void)
{
	return this->m_minZ;
}

float CPlyFile5nt_DX11::getDeltaZ(void)
{
	return this->m_deltaZ;
}

float CPlyFile5nt_DX11::getMaxExtent(void)
{
